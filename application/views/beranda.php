...
<body>
                    ...
                    <div class="carousel-inner">
                        ...
                        foreach ($caraousel as $cara) { ?>
                            <div class="carousel-item <?php if ($no == 1) {
                                ...
                                <img src="<?= base_url('assets/upload/caraousel/' . $cara['foto']) ?>" class="d-block w-100">
                            </div>
                        <?php $no++;
                        } ?>
                    </div>
                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="card border-0 shadow-sm mb-2">
                                ...
                                <div class="card-body bg-light text center p-4">
                                    <h4><?= $uu['judul'] ?></h4>
                                    <div class="">
                                        <small class="mr-3"><i class="fa fa-user text-dark"></i>
                                            <?= $uu['nama'] ?></small>
                                        <small class="mr-3"><i class="fa fa-tag text-dark"></i>
    ...
    <section class="contact-us our-office" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="left-info">
